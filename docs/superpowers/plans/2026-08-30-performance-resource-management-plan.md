...
- [x] **Step 2: Make the control-plane fixture install the metadata it asserts**
...
- [x] **Step 3: Regenerate bindings with the maintained generator**
...
- [x] **Step 4: Update protocol-10 fixture names and canonical expectations**
...
- [x] **Step 5: Prove the baseline repair**
...
- [x] **Step 1: Add a failing benchmark contract test**
...
- [x] **Step 2: Add one explicit service-world setup function**
...
- [x] **Step 3: Generate a valid stage request per iteration**
...
- [x] **Step 4: Make failed repetitions non-publishable**
...
- [x] **Step 5: Run a shortened proof and then the full control**
...
- [x] **Step 1: Write the telemetry regression test**
...
- [x] **Step 2: Fix and document the metric**
...
- [x] **Step 3: Add a dependency-free allocation-count probe**
...
- [x] **Step 1: Add a failing retained-buffer test**
...
- [x] **Step 2: Implement the borrowed-response closure**
...
- [x] **Step 3: Convert production and diagnostic call sites**
...
- [x] **Step 4: Run focused and i686 gates**
...
- [x] **Step 1: Add representative exact-message tests**
...
- [x] **Step 2: Add non-allocating primitive validators**
...
- [x] **Step 3: Reserve exact batch capacity**
...
- [x] **Step 4: Run the full decoder and i686 suite**
...
**Status:** Complete at the Task 12 commit boundary for local Windows qualification. Linux builds
and paired DreamDaemon production acceptance remain explicitly external/unrun gates. The measured
remaining transaction cost produced a separate indexed scratch-arena design rather than an
unreviewed implementation in this plan.
...
- [x] **Step 2: Run repeated controls/candidates and equivalence checks**
...
- [x] **Step 3: Apply acceptance budgets**
...
- [x] **Step 4: Make the transactional-staging decision**
